...
namespace oeg
{
	...
	*/
	auto OegCamera::setOrthographicProjection(
		float left, float right, float top, float bottom, float near, float far) -> void
	{
	...
	/**
		...
		* @param far    The far clipping plane distance.
		*/
	auto OegCamera::setPerspectiveProjection(float fovy, float aspect, float near, float far) -> void
	{
